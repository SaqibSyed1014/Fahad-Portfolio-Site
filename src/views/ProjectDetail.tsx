                ...
                <div className="container">
                    <div className="grid grid-cols-2 gap-32">
                        <div className="">
                            ...
                            <h3 className="section-header-main-heading mb-3">
                                {projectDetail.title}
                            </h3>
                            ...
                            <div className="flex items-center gap-12 mt-16">
                                {Boolean(projectDetail.playStoreLink.length) && <a href={projectDetail.playStoreLink} target="_blank" className="w-44">
                                        ...
                                        <g data-name="Capa 2">
                                            <g data-name="Capa 1">
                                                <path
                                                    ...
                                                    fill="#5f6368"/>
                                                <path d="M13.54 15.28.12 29.34a3.64 3.64 0 0 0 5.33 2.16l15.1-8.6z"
                                                      fill="#ea4335"/>
                                                <path
                                ...
                                {Boolean(projectDetail.appStoreLink.length) && <a href={projectDetail.appStoreLink} target="_blank" className="w-52">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" id="US_UK_Download_on_the"
                        ...
                        <div>
                            ...
                            >
                                {projectDetail.images.map((image, index) => {
                                    return (
                                        <SwiperSlide key={index} onMouseEnter={() => mouseHoverMovement('in')}
                                                     onMouseLeave={() => mouseHoverMovement('out')}
                                                     style={{backgroundColor: projectDetail.color}}
                                                     className="overflow-hidden p-10">
                                            <img loading="eager" src={image} alt={`${projectDetail.title}'s Images`}
